                ...
                <div class="card-body px-0">
                    ...
                    <form id="transactions-form" method="POST" action="fuel_entry.php">
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <a href="add_data.php" class="btn btn-danger me-2">Cancel</a>
                ...
                <div class="modal-body">
                    ...
                    <form id="edit-transaction-form">
                        <div class="mb-3 position-relative">
                            ...
                            <input type="text" class="form-control" id="edit-outlet-name"
                                placeholder="Search Outlet Name" autocomplete="off" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="edit-quantity" placeholder="Quantity"
                                step="0.01" required>
                        </div>
                        <div class="mb-3">
                            <label for="edit-kgs" class="form-label">KGs</label>
                            <input type="number" class="form-control" id="edit-kgs" placeholder="KGs" step="0.01"
                                required>
                        </div>
                    </form>
                </div>
