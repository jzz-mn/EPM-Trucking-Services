  ...
  <div class="container-fluid">
    ...
    <div class="widget-content searchable-container list">
      <div class="card card-body">
        <h4 class="mb-3 mb-sm-0 card-title">Finances</h4>
      </div>
      <!-- Modal -->
              ...
              <div class="tab-pane active" id="home" role="tabpanel">
                <div class="row mt-3">
                  ...
                  <div
                    ...
                    <a href="add-expenses.php" id="btn-add-contact" class="btn btn-primary d-flex align-items-center">
                ...
                <div class="row mb-3">
                  ...
                  <div
                    ...
                    <a href="javascript:void(0)" id="btn-add-contact" class="btn btn-primary d-flex align-items-center">
                      <i class="ti ti-users text-white me-1 fs-5"></i> Add Fuels
                    </a>
                  </div>
                </div>
                <div class="table-responsive">
