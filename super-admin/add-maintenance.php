                  ...
                  <div class="card-body p-4">
                    ...
                    <form>
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="mb-3">
                            <label for="exampleInputtext2" class="form-label">Maintenance ID</label>
                        ...
                        <div class="col-lg-4">
                          <div class="mb-3">
                            <label for="exampleInputtext2" class="form-label">Amount</label>
                            <input type="text" class="form-control" id="exampleInputtext2">
                          </div>
                        </div>
                        <div class="col-lg-12">
                          <div class="mb-3">
                            <label for="exampleInputtext2" class="form-label">Details</label>
                            <input type="text" class="form-control" id="exampleInputtext2">
                          </div>
                        </div>
