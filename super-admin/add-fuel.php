      ...
      <div class="row align-items-center">
        <div class="col-12">
          <div class="d-sm-flex align-items-center justify-space-between">
            <h4 class="mb-4 mb-sm-0 card-title">Add Fuel Expense</h4>
                  ...
                  <div class="card-body p-4">
                    ...
                    <form>
                      <div class="row">
                        <div class="col-lg-4">
                          <div class="mb-3">
                            <label for="exampleInputtext" class="form-label">Diesel ID</label>
                        ...
                        <div class="col-lg-4">
                          <div class="mb-3">
                            <label for="exampleInputtext2" class="form-label">Control Number</label>
                            <input type="text" class="form-control" id="exampleInputtext2">
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="mb-3">
                            <label for="exampleInputtext2" class="form-label">Plate Number</label>
                            <input type="text" class="form-control" id="exampleInputtext2">
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="mb-3">
                            <label for="exampleInputtext2" class="form-label">Series Number</label>
                            <input type="text" class="form-control" id="exampleInputtext2">
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="mb-3">
                            <label for="exampleInputtext" class="form-label">Liters</label>
                            <input type="text" class="form-control" id="exampleInputtext">
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="mb-3">
                            <label for="exampleInputtext2" class="form-label">Unit Price</label>
                            <input type="text" class="form-control" id="exampleInputtext2">
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="mb-3">
                            <label for="exampleInputtext2" class="form-label">Fuel Amount</label>
                            <input type="text" class="form-control" id="exampleInputtext2">
                          </div>
                        </div>
                        ...
                        <div class="col-12">
                          <div class="d-flex align-items-center justify-content-end mt-4 gap-6">
                            <a class="btn btn-primary" href="../super-admin/finance.php">Save</a>
                            <a class="btn bg-danger-subtle text-danger" href="../super-admin/finance.php">Cancel</a>
                          </div>
                        </div>
                      </div>
                    </form>
