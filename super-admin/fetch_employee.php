...
if (isset($_GET['id'])) {
    ...
    $query = "
        SELECT e.EmployeeID, e.FirstName, e.MiddleInitial, e.LastName, e.Gender, e.Position, e.DateOfBirth, e.Address, e.MobileNo, e.EmailAddress AS employeeEmail, e.EmploymentDate,
